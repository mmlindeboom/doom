...
(let ((class '((class color) (min-colors 89)))
      ...
      ;;vterm
      (vterm-default '(:foreground "#333333" :background "#FFDD70"))
      (vterm-color-black  '(:background "#000000"   :foreground "#000000"))
      (vterm-color-red    '(:background "#ff0000"     :foreground "#ff0000"))
      (vterm-color-green  '(:background "#00ff00"   :foreground "#00ff00"))
      (vterm-color-yellow '(:background "#ffff00"   :foreground "#ffff00"))
      (vterm-color-blue   '(:background "#0000ff"    :foreground "#0000ff"))
      (vterm-color-magenta '(:background "#ff00ff" :foreground "#ff00ff"))
      (vterm-color-cyan    '(:background "#019595"    :foreground "#008080"))
      (vterm-color-white   '(:background "#ffdd70"   :foreground "#ffdd70"))
  ...
  (custom-theme-set-faces
   'leuven
   `(default ((,class (:foreground "#333333" :background "#F1F1F1"))))
   ...
   `(vterm-color-default ((,class ,vterm-default)))
   `(vterm-color-white ((,class ,vterm-color-white)))
   ;; Highlighting faces.
   ...
   `(term ((,class (:foreground "#333333" :background "#FFFDD0"))))
